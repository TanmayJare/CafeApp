...
-- CreateEnum
CREATE TYPE "AddressLabel" AS ENUM ('HOME', 'WORK', 'OTHER', 'CUSTOM');
...
-- CreateIndex
CREATE INDEX "DailySpecial_availableFrom_availableUntil_isActive_idx" ON "DailySpecial"("availableFrom", "availableUntil", "isActive");

-- CreateIndex
CREATE INDEX "DailySpecial_sortOrder_idx" ON "DailySpecial"("sortOrder");
